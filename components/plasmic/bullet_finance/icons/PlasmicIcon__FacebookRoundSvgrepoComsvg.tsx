...
export type FacebookRoundSvgrepoComsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function FacebookRoundSvgrepoComsvgIcon(
  props: FacebookRoundSvgrepoComsvgIconProps
) {
...
export default FacebookRoundSvgrepoComsvgIcon;
/* prettier-ignore-end */
