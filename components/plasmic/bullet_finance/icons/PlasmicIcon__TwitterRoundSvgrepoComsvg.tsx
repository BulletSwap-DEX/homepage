...
export type TwitterRoundSvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TwitterRoundSvgrepoComsvgIcon(
  props: TwitterRoundSvgrepoComsvgIconProps
) {
...
export default TwitterRoundSvgrepoComsvgIcon;
/* prettier-ignore-end */
