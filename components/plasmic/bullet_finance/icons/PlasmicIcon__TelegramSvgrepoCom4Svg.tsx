...
export type TelegramSvgrepoCom4SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TelegramSvgrepoCom4SvgIcon(
  props: TelegramSvgrepoCom4SvgIconProps
) {
...
export default TelegramSvgrepoCom4SvgIcon;
/* prettier-ignore-end */
