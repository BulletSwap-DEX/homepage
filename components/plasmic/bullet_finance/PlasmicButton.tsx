...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HGSty6rZ08u/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: R0LO7nqIljI/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: nkTOxUhFR0H/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___2CYhj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__yjsI9)}
                role={"img"}
              />
            ),
